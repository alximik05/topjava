...
//        System.out.println(getFilteredMealsWithExceededByCycle(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    ...
    public static List<UserMealWithExceed> getListForTest() {
        ...
        return getFilteredMealsWithExceeded(mealList, LocalTime.of(7, 0), LocalTime.of(22, 0), 2000);
    }




    public static boolean create(UserMeal meal) {
         return mealList.add(meal);
    }

    public static boolean delete(UserMeal meal) {
